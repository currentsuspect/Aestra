...
public:
     ...
     */
    void setPluginScanner(Nomad::Audio::PluginScanner* scanner);
     ...
     */
    void bindEffectRack(EffectChainRack* rack, Nomad::Audio::EffectChain* chain);
     ...
     */
    void removePluginFromSlot(Nomad::Audio::EffectChain* chain, int slot);
     ...
     */
    void openPluginEditor(std::shared_ptr<Nomad::Audio::IPluginInstance> instance,
...
private:
    ...
    PluginListItem convertToListItem(const Nomad::Audio::PluginInfo& info) const;
    
    // Backend references
    Nomad::Audio::PluginScanner* m_scanner = nullptr;
    Nomad::Audio::PluginManager* m_manager = nullptr;
...
public:
     ...
     */
    bool open(std::shared_ptr<Nomad::Audio::IPluginInstance> instance,
     ...
     */
    std::shared_ptr<Nomad::Audio::IPluginInstance> getPluginInstance() const;
