...
- **../AestraDocs/architecture/NOMADUI_COORDINATE_SYSTEM.md** - Comprehensive guide with examples, debugging tips, and best practices

### Quick References
- **../docs/technical/ui/COORDINATE_SYSTEM_QUICK_REF.md** - Quick reference card for developers
...
- **../AestraDocs/guides/DEVELOPER_GUIDE.md** - Added architectural rule about coordinate system
...
- [AestraUI_COORDINATE_SYSTEM.md](../AestraDocs/architecture/NOMADUI_COORDINATE_SYSTEM.md) - Full documentation
- [COORDINATE_SYSTEM_QUICK_REF.md](../docs/technical/ui/COORDINATE_SYSTEM_QUICK_REF.md) - Quick reference
- [CUSTOM_WINDOW_INTEGRATION.md](../AestraDocs/systems/CUSTOM_WINDOW_INTEGRATION.md) - Custom window setup
- [DEVELOPER_GUIDE.md](../AestraDocs/guides/DEVELOPER_GUIDE.md) - Development guidelines
