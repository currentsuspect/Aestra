...
- **../docs/architecture/AestraUI_COORDINATE_SYSTEM.md** - Comprehensive guide with examples, debugging tips, and best practices
...
- [../docs/architecture/AestraUI_COORDINATE_SYSTEM.md](../docs/architecture/AestraUI_COORDINATE_SYSTEM.md) - Full documentation
- [../docs/technical/ui/COORDINATE_SYSTEM_QUICK_REF.md](../docs/technical/ui/COORDINATE_SYSTEM_QUICK_REF.md) - Quick reference
