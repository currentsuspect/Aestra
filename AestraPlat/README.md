...
Cross-platform abstraction layer for the Aestra project.

## Overview

AestraPlat provides a unified interface for platform-specific functionality:
...
AestraPlat follows an interface-based design for easy platform switching:
...
// Clipboard
utils->setClipboardText("Hello from Aestra!");
...
./build/AestraPlat/Release/PlatformWindowTest.exe
```
...
void PlatformWindowCocoa::assertWindowThread() const {
    Aestra_ASSERT(GetCurrentThreadId() == m_creatingThreadId,
