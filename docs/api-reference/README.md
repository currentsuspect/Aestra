...
- **AestraCore** - Foundation utilities (math, threading, logging, file I/O)
- **AestraAudio** - Audio engine and device management
- **AestraPlat** - Platform abstraction layer (window, input, dialogs)
- **AestraUI** - GPU-accelerated UI framework
...
**Generated by Doxygen** | **Aestra** © 2025 Aestra Studios
