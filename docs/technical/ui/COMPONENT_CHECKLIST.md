...
- [AestraUI_COORDINATE_SYSTEM.md](../../../AestraDocs/architecture/NOMADUI_COORDINATE_SYSTEM.md) - Full guide

When stuck, check:
- [TRANSPORT_BAR_FIX_SUMMARY.md](../../../meta/TRANSPORT_BAR_FIX_SUMMARY.md) - Real-world example
