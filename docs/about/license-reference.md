...
While you grant full rights, we value contributions:
- 🏆 Contributors listed on GitHub
...
**A:** Licensing model (perpetual vs. subscription) will be announced upon release.
...
- 📖 Contributing Guide: [CONTRIBUTING.md](../developer/contributing.md)

## 🌍 Jurisdiction

**Legal jurisdiction:**
- **Primary**: Republic of Kenya
- **International**: Subject to international copyright treaties
