...
// Platform-specific SIMD headers
    ...
    #include <immintrin.h>
    #define NOMAD_WAVEFORM_HAS_SSE 1
#endif

#if defined(__ARM_NEON) || defined(__ARM_NEON__) || defined(__aarch64__)
    #include <arm_neon.h>
    #define NOMAD_WAVEFORM_HAS_NEON 1
#endif
...
#endif // NOMAD_WAVEFORM_HAS_SSE

#ifdef NOMAD_WAVEFORM_HAS_NEON
