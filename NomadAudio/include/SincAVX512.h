...
// It is only called when CPUDetection confirms AVX-512F support.
#pragma once

#include <immintrin.h>

#if defined(__GNUC__) || defined(__clang__)
#define NOMAD_AVX512_TARGET __attribute__((target("avx512f,avx512dq")))
#else
#define NOMAD_AVX512_TARGET
#endif
 ...
 */
NOMAD_AVX512_TARGET
inline void sincDotProductAVX512(
    const float* coeffs,
 ...
 */
NOMAD_AVX512_TARGET
inline void sincDotProductAVX512_Reversed(
    const float* coeffs,
    const float* samples,
    float& sumL, float& sumR)
{
