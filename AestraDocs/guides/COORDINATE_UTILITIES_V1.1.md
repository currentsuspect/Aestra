# AestraUI Coordinate System Utilities v1.1
...
While AestraUI maintains its absolute coordinate system (no automatic transformation), we've added utility helpers to make positioning more ergonomic and less error-prone.
...
All utilities are defined in `AestraUI/Core/NUITypes.h` as inline functions.
...
This approach aligns with Aestra's philosophy:
...
- **AestraDocs/COORDINATE_UTILITIES_V1.1.md** - This document
