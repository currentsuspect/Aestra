...
The **Adaptive FPS System** for AestraUI intelligently manages frame pacing between 30 and 60 FPS based on user activity and system performance, providing a fluid experience while preserving CPU and thermal efficiency.
...
The adaptive FPS system is **already integrated** into the Aestra main application. No additional setup required!
...
m_adaptiveFPS->setMode(AestraUI::NUIAdaptiveFPS::Mode::Auto);

// Lock to 30 FPS
m_adaptiveFPS->setMode(AestraUI::NUIAdaptiveFPS::Mode::Locked30);

// Lock to 60 FPS
m_adaptiveFPS->setMode(AestraUI::NUIAdaptiveFPS::Mode::Locked60);
```
...
Part of the Aestra project - Proprietary
