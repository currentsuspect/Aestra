...
**Location**: `AestraUI/Graphics/NUITextRendererSDF.cpp:168`
...
1. `AestraUI/Graphics/NUITextRendererSDF.cpp` - Main fixes
2. `AestraUI/Graphics/NUITextRendererSDF.h` - Add quality enum  
3. `AestraUI/Graphics/NUIRendererGL.cpp` - DPI scaling integration
