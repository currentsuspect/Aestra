# Aestra Audio Driver System Documentation
...
Aestra implements a professional multi-tier audio driver system with intelligent fallback and seamless driver switching. The system prioritizes low-latency WASAPI drivers with automatic format negotiation and conversion.
...
**Location:** `AestraAudio/src/AudioDeviceManager.cpp`
...
**Location:** `AestraAudio/src/WASAPIExclusiveDriver.cpp`
...
**Location:** `AestraAudio/src/WASAPISharedDriver.cpp`
...
```cpp
#include "AestraAudio/AudioDeviceManager.h"
...
**Core Implementation:**
- `AestraAudio/src/AudioDeviceManager.cpp` - Main controller
- `AestraAudio/src/WASAPIExclusiveDriver.cpp` - Exclusive mode
- `AestraAudio/src/WASAPISharedDriver.cpp` - Shared mode
- `AestraAudio/src/ASIODriverScanner.cpp` - ASIO detection

**Headers:**
- `AestraAudio/include/AudioDeviceManager.h`
- `AestraAudio/include/NativeAudioDriver.h`
- `AestraAudio/include/AudioDriverTypes.h`
...
**Documentation:**
- `AestraDocs/AUDIO_DRIVER_SYSTEM.md` - This file
- `AestraAudio/README.md` - Module overview
