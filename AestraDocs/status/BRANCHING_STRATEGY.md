# Aestra Git Branching Strategy v1.0
...
git tag -a v1.0.0 -m "Aestra v1.0.0 - milestone description"
...
```example
feat: implement RtAudio backend for AestraAudio
...
Architecture: AestraAudio, AestraCore (threading)
```
...
Architecture: AestraUI, AestraRenderer
```

**Refactor:**

```example
refactor: extract platform window code to AestraPlat

- Move Win32 window creation from AestraUI to AestraPlat
- Create platform abstraction interface
- No behavior changes, pure architectural cleanup

Architecture: AestraPlat, AestraUI
```

## Current State

- ✅ `main`: Clean foundation (AestraUI complete, JUCE removed)
