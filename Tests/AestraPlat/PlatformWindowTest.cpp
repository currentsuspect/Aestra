...
bool testPlatformUtils() {
    ...
    // Test clipboard
    std::string testText = "AESTRA Platform Test";
...
bool testWindowCreation() {
    ...
    WindowDesc desc;
    desc.title = "AESTRA Platform Test";
    desc.width = 800;
    desc.height = 600;
...
bool testWindowState() {
    ...
    // Test title change
    window->setTitle("AESTRA - Title Changed");
...
int main() {
    ...
    std::cout << "\n==================================" << std::endl;
    std::cout << "  AestraPlat Platform Tests" << std::endl;
    std::cout << "==================================" << std::endl;
