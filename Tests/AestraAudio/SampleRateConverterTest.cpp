...
void testRoundTrip() {
    ...
    const uint32_t upFrames = Aestra::Audio::estimateOutputFrames(frames, originalRate,
    ...
    const uint32_t downFrames = Aestra::Audio::estimateOutputFrames(upWritten, intermediateRate,
