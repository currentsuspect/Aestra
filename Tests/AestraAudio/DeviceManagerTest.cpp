...
int main() {
    std::cout << "=========================================\n";
    std::cout << "  AestraAudio Device Manager Test Suite\n";
    std::cout << "=========================================\n";
    ...
    if (!testDeviceEnumeration(manager))
        failedTests++;
    if (!testDeviceSelection(manager))
        failedTests++;
    if (!testSampleRateConfiguration(manager, sineData))
        failedTests++;
    if (!testBufferSizeConfiguration(manager, sineData))
        failedTests++;
    if (!testDeviceSwitching(manager, sineData))
        failedTests++;
    if (!testDynamicConfiguration(manager, sineData))
        failedTests++;
