// AestraVerb Modulation Baseline Lab (F4 pre-rewrite measurement)
//
...
int main() {
    ...
    std::cout << "AestraVerb Modulation Baseline Lab (F4 pre-rewrite)\n";
    std::cout << "===================================================\n\n";

    std::ostringstream md, js;
    md << "# AestraVerb Modulation Baseline (F4 pre-rewrite)\n\n";
