...
void AestraDelayEditor::drawTitleBar(NUIRenderer& renderer) {
    ...
    renderer.drawText("Aestra Delay", {titleBar.x + kPad, titleBar.y + 14.0f}, 13.0f, theme.getColor("textPrimary"));
    renderer.drawText("Stereo delay w/ modulation", {titleBar.x + 120.0f, titleBar.y + 15.0f}, 10.0f,
                      NUIColor(0.6f, 0.3f, 1.0f).withAlpha(0.85f));
    ...
    renderer.drawLine({titleBar.x, titleBar.bottom()}, {titleBar.right(), titleBar.bottom()}, 1.0f, NUIColor(1,1,1,0.06f));
}
