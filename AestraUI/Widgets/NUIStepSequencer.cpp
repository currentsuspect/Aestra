...
void StepSequencerView::onRender(NUIRenderer& renderer) {
    ...
    // Grid + steps
    AestraUI::NUIColor activeColor = theme.getColor("accentPrimary");
    AestraUI::NUIColor activeBorder = theme.getColor("border").withAlpha(0.8f);
    AestraUI::NUIColor inactiveColor = theme.getColor("surfaceTertiary");
    AestraUI::NUIColor hoverColor = theme.getColor("accentCyan").withAlpha(0.35f);
