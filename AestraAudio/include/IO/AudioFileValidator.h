...
public:
    ...
    static bool hasValidAudioExtension(const std::string& path) {
        ...
        static constexpr std::array<std::string_view, 14> validExtensions = {".wav", ".wave", ".mp3", ".flac", ".ogg",
                                                                             ".oga", ".aiff", ".aif", ".aifc", ".m4a",
                                                                             ".mp4", ".aac",  ".wma", ".opus"};
    ...
    static bool validateFileHeader(const std::string& path) {
        ...
        static const uint8_t asfGuid[16] = {0x30, 0x26, 0xB2, 0x75, 0x8E, 0x66, 0xCF, 0x11,
     ...
     */
    static std::string getSupportedExtensions() { return "WAV, MP3, FLAC, OGG, AIFF, M4A, WMA, OPUS"; }
