...
public:
     ...
     */
    std::vector<PluginInfo> getEffectPlugins() const { return getPluginsByType(PluginType::Effect); }

    /**
     * @brief Get all instrument plugins
     */
    std::vector<PluginInfo> getInstrumentPlugins() const { return getPluginsByType(PluginType::Instrument); }
