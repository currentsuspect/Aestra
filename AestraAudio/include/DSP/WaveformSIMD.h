 ...
 */
inline void minMaxChannel(const float* data, size_t numFrames, uint32_t numChannels, uint32_t channel,
                          size_t startFrame, size_t endFrame, float& outMin, float& outMax) noexcept {
