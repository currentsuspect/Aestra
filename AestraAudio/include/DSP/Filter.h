 ...
 */
enum class FilterSlope { Slope12dB = 0, Slope24dB, Slope48dB };
 ...
 */
enum class SaturationType { None = 0, SoftClip, HardClip, Tanh, Asymmetric };

/**
 * @brief Parameter smoothing types
 */
enum class SmoothingType { Linear = 0, Exponential, Cosine };
