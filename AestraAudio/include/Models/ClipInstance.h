...
struct ClipInstanceID : public AestraUUID {
    ...
    static ClipInstanceID generate() {
        return ClipInstanceID(AestraUUID::generate());
    }
...
struct PlaylistLaneID : public AestraUUID {
    ...
    static PlaylistLaneID generate() {
        return PlaylistLaneID(AestraUUID::generate());
    }
...
namespace std {
    template<>
    struct hash<Aestra::Audio::ClipInstanceID> {
    ...
    template<>
    struct hash<Aestra::Audio::PlaylistLaneID> {
